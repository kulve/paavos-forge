...
5. **If rejected:**
   ...
   - Annotate: `taskwarrior/tw <id> annotate "Plan-feedback: plan/implementation-plan-review/XXXXX-feedback.md"`
...
Reject:
```bash
taskwarrior/tw <id> annotate "Plan-feedback: plan/implementation-plan-review/XXXXX-feedback.md"
...
If the plan is fundamentally flawed after 3 review rounds, write an escalation to `plan/escalations/XXXXX-impl-plan-review-loop.md` with the pattern of failures.
