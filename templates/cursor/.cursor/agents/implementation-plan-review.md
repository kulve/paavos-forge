...
5. **If rejected:**
   ...
   - Annotate: `ccmd bash taskwarrior/phase-annotate <id> Plan-feedback plan/implementation-plan-review/XXXXX-feedback.md`
...
Reject:
```bash
ccmd bash taskwarrior/phase-annotate <id> Plan-feedback plan/implementation-plan-review/XXXXX-feedback.md
